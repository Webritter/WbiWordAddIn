...
import {IWbiOrganization, IWbiOwner} from '../services/wbi/wbi-types';
...
interface IProps {
  label: string;
  onChange: (org: IWbiOwner) => void;
  organization : IWbiOrganization | null;
  selected : IWbiOwner | null;
  disabled: boolean;
}
...
export class WbiOwnerPicker extends Component<IProps, IState> {
